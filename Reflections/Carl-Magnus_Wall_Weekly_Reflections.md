...
Vecka 6 kändes ganska välstrukturerad. Vi hade en tydlig utgångspunkt och tydlig uppdelning av uppgifter. Vår sprint velocity låg på 68 (av maximalt 70). Dock var stressnivåerna högre än tidigare, vilket främst berodde på ytter omständigheter. Jag utsattes till ny sprint master och känner att jag har hållit bra koll på gruppen i helhet. Vi har tidigare haft bra koll på vår stress- samt velocity-KPI, men denna veckan har vi verkligen förbättrat vår arbetsätt kring vår kvalitets-KPI. Under början av sprinten, när vi bestämde våra tasks, fick intresserade anmäla sig som code reviewers. Vi uppdaterade vårt sociala kontrakt där vi bestämde att code reviews skall senast genomföras på fredagar om inte särskilt skäl anges. Absolut senast på söndagar skall en code review färdigställas, så att vi kan merga innan sprinten avklarats. Detta har fungerat bra och jag har känt att checklistan som vi tagit fram har hjälpt till att säkerställa ordentlig kvalitetssäkring av kod. Jag var själv inte code reviewer under veckan, men jag känner att checklistan underlättade för mig att förstå de kodändringar som införts. Särskilt om en viss del av checklistan inte godkändes. Jag gick alltid in och tittade mer noggrant ifall något inte godkänts. Det vanligaste problemet var att kod inte kommenterats utförligt nog. I och med att fler pull requests har nekats, så har vi behövt diskutera problemen mer utförligt, vilket har ökat både kodkvaliteten och förståelse av koden i helhet.

Som scrum master har jag hållit i veckans möten och fördelat arbetsuppgifter utefter mina gruppmedlemmars möjligheter. Vi har alla varit väldigt upptagna med andra kurser och kandidatarbeten, men jag känner ändå att jag kunde fördela arbetet på ett rättvist sätt. Snacket i gruppen har varit bra och under våra möten har vi diskuterat ganska omfattande om våra olika tasks samt utmaningar/buggar. Mina tasks har innefattat fortsatt arbete med implementering av Outlook-kalendern samt utförande av en kundundersökning. Jag hjälpte till att strukturera undersökningen och var även ute på boendeparkeringar och delade ut lappar med information samt QR-kod/länk till undersökningen. Totalt 169 lappar har lämnats ut. Undersökningen har även delats på Facebook, och jag hoppas att vi hinner få in tillräckligt med data för kunna få en så tydlig användarbild som möjligt.

Kalenderimplementeringen är mer eller mindre färdig, men hann inte mergas innan sprinten avklarades. Under utvecklingen upptäckte vi en bugg som påverkar både Google- och Microsoft-kalendrarna, så det känns ändå lugnt att det släpar lite. Jag känner att jag har full koll på vad som behöver göras. Vår verkliga velocity landade på 49, vilket ligger en bit under det vi började med, men detta berodde främst på en missberäkning gällande två av våra tasks. Den ena tasken gällde ersättning av en inloggningsknapp med en enda knapp som både sköter inloggning och tilläggning i kalender. Detta fungerade inte som tänkt. Den andra gällde Outlook-implementationen, som tog längre tid än förväntat. Vi kommer diskutera dessa och samsas om lösningar i nästa sprint.

Det som saknas just nu är färdigställning av våra sista features, buggfixar, ordentlig testning samt en omdesign av applikation. Vi måste öka användarvänligheten på den visuella fronten. Jag vill gärna vara med och lära mig om design och frontend från mina gruppmedlemmar.

Jag känner mer än någonsin att jag ser fördelarna med den agila utvecklingsmetoden vi utnyttjar. Jag känner att fragmenteringen (sprints) ger ett slags "lösare" deadlines. Att vi sätter upp mål som skall genomföras ger en känsla av konstant framgång och har minskat stressen för mig. Jag har tidigare oftast haft ögonen på den slutgiltiga deadlinen och att det viktiga är man är färdig först då. Sprintsen bidrar med väldigt tydliga mål för hur vi tar oss till nästa steg i utvecklingen. I tidigare kurser har det ibland varit omjämn fördelning av börda och ibland har man fått göra för mycket i sista sekund på grund av till exempel bristande kommunikation.

Jag känner mig väldigt bekväm i detta arbetsättet nu och jag ser fram emot att applicera det i framtiden. Jag vill absolut lära mig mer om hur man arbetar ännu bättre med Scrum.

**What it might or should be:**

Jag tycker att vi har kommit in i ett väldigt bra flow som grupp nu och vi arbetar ganska bra utefter våra KPIer. Vi har känt oss ganska lugna under kursens gång, men i och med att stressnivåerna har varit lite högre under den senaste veckan, så behöver vi vara väl förberedda på ökad workload inför kommande sprint. Det är extra viktigt just nu att vi talar med varandra om hur det går med våra tasks. Vi måste se till att fördela våra tasks utefter våra styrkor mer än någonsin känner jag. Jag känner mig ganska bekväm med både kod och rapportskrivning, men lite mindre bekväm med design/frontend.

Vi behöver en mycket detaljerad sprint, då vi har flera olika typer av uppgifter under denna vecka. Vi behöver kunna lita på vi alla klarar av våra tasks utan för mycket stress. Vi behöver alla vara bekväma med de uppgifter vi tagit åt oss. Jag vill gärna kunna fortsätta arbeta med att färdigställa kalenderfunktionerna, men även påbörja rapportskrivning och leta efter buggar. Om det finns tid över vill jag gärna diskutera designval med de som har ansvar för denna del av projektet. Jag känner att jag behöver kunna mer om detta för att kunna ge värdefulla åsikter i framtida projekt.

Gällande vår kundundersökning har vi fått tips av våra handledare att arbeta med någon KPI och det tycker jag låter väldigt rimligt. Datan som vi samlar ihop måste vara relevant för vårt projekt och om vi arbetar med typ av KPI kan vi lättare säkerställa att vi behandlar datan på ett så bra sätt som möjligt.

**Feedback designed to reduce the gap:**

Med tanke på att vi behöver ha fortsatt bra kommunikation, känner jag att vi behöver ha minst ett extra standup meeting den här veckan. Vi måste verkligen förbereda oss för våra sista presentation. I och med att vi har kod, design och slutrapport att arbeta med, så behöver vi se längre framåt. Jag ska föreslå och kalla till spontana möten under veckan för att komma underfund med hur det går för de andra i min grupp. Om jag märker att någon inte hunnit med så mycket som det velat, så ska jag försöka hjälpa till på de sätt jag kan. Förra veckan var jag själv väldigt stressad över saker utanför detta arbetet, och jag känner att jag hade behövt tala om detta för någon. Arbetet hade fortskridit smidigare om jag hade gjort detta och om jag kan hjälpa någon i gruppen utan att de behöver fråga, så tror jag stämningen kan blir lugnare hos den personen.

Jag måste lägga fokus där det behövs som mest. Just nu är det viktigt att färdigställa alla funktioner, så att vi kan testa efter buggar. Därefter skall jag skapa en mall för vår projektrapport. För att kunna komma igång med rapporten är det viktigt att jag inte ligger efter med min del av koden, så koden måste ha högst prioritet. Kalenderfunktionen bör vara klar senaste tisdag. Ju tidigare jag blir färdig, desto mer kan jag hjälpa mina gruppmedlemmar och lära mig mer om design/frontend. Det enda som egentligen krävs för att bli färdig nu är min egna tid. Jag vet vad som behöver göras för att färdigställa min kod.

Jag ska också se till att sammanställa datan i vår kundundersökning samt kika på olika KPIer som kan hjälpa oss i detta syfte.
